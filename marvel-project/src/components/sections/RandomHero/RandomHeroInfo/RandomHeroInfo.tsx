                    ...
                    <div className="flex">
                        ...
                        <div className="flex flex-col ml-7.5 mw-[250px]">
                            ...
                            <div className="flex gap-10 mt-6 text-[16px]">
                                <a href="#" className="bg-[#9F0013] text-center text-white tracking-wide px-4 py-3 [clip-path:polygon(0_0,100%_0,100%_70%,92%_100%,0_100%,0_30%,8%_0)] hover:bg-[#db2a3fe7]">
                                    HOMEPAGE
                                </a>
                                <a href="#" className="bg-[#5C5C5C] text-center text-white tracking-wide px-11.5 py-3 [clip-path:polygon(0_0,100%_0,100%_70%,92%_100%,0_100%,0_30%,8%_0)] hover:bg-[#3a3535] ">
                                    WIKI
                                </a>
                            </div>
                        </div>
